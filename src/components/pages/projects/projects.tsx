          ...
          {projects.map((project) => {
            ...
            return (
              <SwiperSlide key={project.id}>
                {({ isActive }) => (
// التعديل: حذف /${locale} لأن Link الخاص بـ routing يتكفل بها
<Link href={`/projects/${project.slug}`}>                    <motion.div
                            ...
                            <div className="flex flex-wrap items-center gap-4 pt-2">
                              ...
                              <div className="flex flex-wrap items-center gap-3">
                                <div className="flex items-center gap-1.5 text-slate-500 dark:text-slate-400 font-bold text-[10px]">
                                  ...
                                  <span>{locale === 'ar' ? 'المساحة:' : 'Area:'} {project.area}</span>
                                </div>
                                <div className="flex items-center gap-1.5 text-slate-500 dark:text-slate-400 font-bold text-[10px]">
                                  <LayoutGrid size={13} className="text-amber-500" />
                                  <span>{locale === 'ar' ? 'الوحدات:' : 'Units:'} {project.units || '—'}</span>
                                </div>
                              </div>
                            </div>
                          </div>
